...
function todoList() {
    ...
    function renderTask() {
        ...
        allTask.innerHTML = sum || '<p>No tasks added yet</p>'
...
function weatherFunctionality() {
    ...
    header2Temp.innerHTML = '24°C'
    header2Condition.innerHTML = 'Partly Cloudy'
    wind.innerHTML = 'Wind: 12 km/h'
    humidity.innerHTML = 'Humidity: 65%'
    precipitation.innerHTML = 'Precipitation: 20%'
